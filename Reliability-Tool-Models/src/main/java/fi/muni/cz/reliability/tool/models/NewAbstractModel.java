 ...
 */
public abstract class NewAbstractModel implements Model {
     ...
     */
    public NewAbstractModel(List<Pair<Integer, Integer>> listOfIssues, 
     ...
     */
    protected abstract void calculateModelParameters();
